...
<?php
  ...
  <article>
    ...
    <div class = "btn-group">
          ...
          <button class="mem_info" onclick="location.href='#'" >나의 리뷰</button>
          <button class="mem_info">문의 현황</button>
          <br>
          <button class="mem_info_1" onclick="location.href='#'" >내 작품 판매하기</button>
          <button class="mem_info_1" onclick="location.href='review_my_work.html'" >내 작품 리뷰보기</button>
  </div>
  <br>
  <br>
<br>
