...
<body>
    ...
    <!--본문 시작-->
        ...
        <article>
            <div class = "h1_top"><h1>실물 아트 경매</h1></div>
        
        <div class = "rudfh">홈 > 경매 > 전체 > 실물 아트 경매</div>
    ...
    <div class="second-box">
        <div class="img_list">
            <ul style="padding: 0;">
                ...
                <li>
                    <div class="img_list_info">
                        <img src="../img/auction/new_2.jpg" width="90%" class="bottom">
                        <h1>노을</h1>
                        <p>현재가: 360,064 원</p>
                        <h2>67:33:57</h2>
                ...
                <li>
                    <div class="img_list_info">
                        <img src="../img/auction/new_3.jpg" width="90%" class="bottom">
                        <h1>목도리냥</h1>
                        <p>현재가: 278,200 원</p>
                        <h2>65:04:28</h2>
                        <div class="status"><a href=""> 입찰 </a></div>
                ...
                <li>
                    <div class="img_list_info">
                        <img src="../img/auction/new_4.png" width="90%" class="bottom">
                        <h1>우리 집 앞</h1>
                        <p>현재가: 459,768 원</p>
                        <h2>62:39:39</h2>
                        <div class="status"><a href=""> 입찰 </a></div>
                ...
                <li>
                    <div class="img_list_info">
                        <img src="../img/auction/new_5.png" width="90%" class="bottom">
                        <h1>멍때림</h1>
                        <p>현재가: 203,200 원</p>
                        <h2>68:49:12</h2>
                        <div class="status"><a href=""> 입찰 </a></div>
                ...
                <li>
                    <div class="img_list_info">
                        <img src="../img/auction/new_6.png" width="90%" class="bottom">
                        <h1>골목</h1>
                        <p>현재가: 203,200 원</p>
                        <h2>68:49:12</h2>
                        <div class="status"><a href=""> 입찰 </a></div>
