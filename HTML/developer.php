...
<body>
  ...
  <div class="rdochang">
    <input type="radio" id="menu1rdo" name="menu" value="menu1">
    ...
    <div id="menu3" class="menu">
      ...
      <div class="de_box">
        ...
        <div class="gap_1"></div>
        <div class="de_com">작업을 하면서 스트레스도 많이 많고 팀원들과 의견충돌이 있었지만 저에게 꼭 필요한 경험이었고 이를 통해 조금은 성장했다는 생각이 드네요:) 남은 기간 조금 더 힘내봐요 화이팅~~</div>
      </div><!--de_box-->
    ...
    <div id="menu4" class="menu">
      ...
      <div class="de_box">
        <div class="de_name">박성주(BARK SUNG JU)</div>
        <div class="gap_1"></div>
        <div class="de_edu">서일대 소프트웨어공학과 3학년</div>
        <div class="gap_1"></div>
    ...
    <div id="menu5" class="menu">
      ...
      <div class="de_box">
        <div class="de_name">박서영(BARK SEO YOUNG)</div>
        <div class="gap_1"></div>
        <div class="de_edu">서일대 소프트웨어공학과 3학년</div>
        <div class="gap_1"></div>
