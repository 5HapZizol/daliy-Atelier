...
<head>
    <meta charset="UTF-8">
    <link rel="stylesheet" href="../css/best_5.css">  
...
<?php
  ...
  <div style="margin-top: 140px;">
      <div class="art_auction_info">
        <img src="../img/auction/done_digi_7.jpg" width="40%" height="40%">
        <div class="art_auction_info_right">
            <div class="art_info_text_box">
                <div class="title">끝 없는</div>
                <br>
                <div class="artist">김라엘</div>
                <div class="category">#자연 #초자연 #밝은 #강 #실물아트</div>
                <div class="start_price">시작가: 100,000 원</div>
                <div class="left_time">남은시간: 00:00:00</div>
                <br>
                <div class="current_price">최종 낙찰가: 390,000 원</div>
            </div>
    ...
    <div class="art_introduce">
        ...
        <hr/>
        <div>넓고 넓은, 끝도 안 보이는 바다를 보며,</div>
        <div>내 걱정따위 아무것도 아니길</div>
    </div>
    <div class="artist_introduce">
        <div class="top">작가 소개</div>
        <hr/>
        <div>2023년 새로 데뷔한 신인작가, 내면에 감춰진 마음을 표현하는 작가이며,</div>
        <div>의식주로 죽어갈 일이 없는 지금 사회에는 외면보단 내면의 상처가 더 많다.</div>
        <div>2020년 서일대학교 소프트웨어공학과를 졸업 후, 취미로 활동하고 있다.</div>
        <div>대표작으론 코딩으로 예술하기 작품이 있다.</div>
    </div>
    ...
    <div class="artist_other_art">
        ...
        <ul>
          <li>
              <img src="../img/auction/done_digi_2.jpg" width="90%" class="bottom" style="
              vertical-align: text-bottom;">
          </li>
          <li>
              <img src="../img/auction/done_digi_3.jpg" width="90%" class="bottom" style="
              vertical-align: text-bottom;">
          </li>
          <li>
              <img src="../img/auction/done_digi_4.jpg" width="90%" class="bottom" style="
              vertical-align: text-bottom;">
          </li>
          <li>
...
<script>
  ...
  const open = () => {
    ...
    document.querySelector(".review_box").addEventListener("click", open);
    document.querySelector(".close_btn").addEventListener("click", close);
}

    secondScriptFunction(); // 스크립트 실행
</script>
</body>
</html>