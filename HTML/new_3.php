...
<head>
    <title>작품 페이지</title>
    <link rel="stylesheet" href="../css/new_3.css">
    ...
    <div class="modal hidden">
      ...
      <div class="modalBox">
          ...
          <div class="inputMoney">
              입찰가 : <input type="text" placeholder="360,064 이상">원
          </div>
          <div class="buttonBox">
