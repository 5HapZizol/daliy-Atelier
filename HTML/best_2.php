...
<head>
    <title>작품 페이지</title>
    <link rel="stylesheet" href="../css/best_2.css">
...
<?php
  ...
  <article>
    <div class="art_auction_info">
      <img src="../img/auction/best2.png" width="50%">
      <div class="art_auction_info_right">
          <div class="art_info_text_box">
              <div class="title">역류</div>
              ...
              <div class="current_price">현재 최고가: 900,000 원</div>
          </div>
...
<div class="modal hidden">
  ...
  <div class="modalBox">
      ...
      <div class="inputMoney">
          입찰가 : <input type="text" placeholder="900,000 이상">원
      </div>
      <div class="buttonBox">
